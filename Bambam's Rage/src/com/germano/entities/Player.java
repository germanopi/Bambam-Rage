	...
	public void render(Graphics g) {
		...
		if (!isDamaged) {
			...
			if (dir == right_dir) {
				...
				if (hasWeapon) {
					g.drawImage(Entity.HALTER_SHOOT_OR_HAND_EN, this.getX() + 12 - Camera.x,
							this.getY() + 9 - Camera.y - z, null);
				}
				...
				if (hasWeapon) {
					g.drawImage(Entity.HALTER_SHOOT_OR_HAND_EN, this.getX() - 5 - Camera.x,
							this.getY() + 9 - Camera.y - z, null);
				}
			}
			// Se levou dano
			...
			if (dir == right_dir) {
				...
				if (hasWeapon) {
					g.drawImage(Entity.HALTER_SHOOT_OR_HAND_WHITE_EN, this.getX() + 12 - Camera.x,
							this.getY() + 9 - Camera.y - z, null);
				}
				...
				if (hasWeapon) {
					g.drawImage(Entity.HALTER_SHOOT_OR_HAND_WHITE_EN, this.getX() - 6 - Camera.x,
							this.getY() + 9 - Camera.y - z, null);
				}
			}
		}
